-- ============================================================================
-- 20260904090200_review_photos.sql
-- General site photos in the review flow.
--
-- The table already existed for the record and PDF appendix. This migration
-- adds a nullable section label and teaches apply_entry_review() to replace the
-- photo rows with what the supervisor confirmed.
-- ============================================================================
...
alter table public.photos
  ...
  check (category is null or category in ('works', 'delay', 'variation', 'pour', 'safety', 'general'));

comment on column public.photos.category is
  'Supervisor label for general site photos: works, delay, variation, pour, safety or general.';
